...
.method private static applyWorkarounds(Ljava/util/List;)V
    ...
    .line 413
    .end local v0    # "decoderInfo":Lcom/google/android/exoplayer2/mediacodec/MediaCodecInfo;
    .end local v1    # "i":I
    :cond_0
    return-void

    .line 404
    .restart local v0    # "decoderInfo":Lcom/google/android/exoplayer2/mediacodec/MediaCodecInfo;
...
.method public static declared-synchronized getDecoderInfos(Ljava/lang/String;Z)Ljava/util/List;
    ...
    .line 143
    const-class v8, Lcom/google/android/exoplayer2/mediacodec/MediaCodecUtil;

    monitor-enter v8

    :try_start_0
    new-instance v4, Lcom/google/android/exoplayer2/mediacodec/MediaCodecUtil$CodecKey;

    invoke-direct {v4, p0, p1}, Lcom/google/android/exoplayer2/mediacodec/MediaCodecUtil$CodecKey;-><init>(Ljava/lang/String;Z)V

    .line 144
    .local v4, "key":Lcom/google/android/exoplayer2/mediacodec/MediaCodecUtil$CodecKey;
    sget-object v7, Lcom/google/android/exoplayer2/mediacodec/MediaCodecUtil;->decoderInfosCache:Ljava/util/HashMap;
    ...
    .line 145
    .local v0, "cachedDecoderInfos":Ljava/util/List;, "Ljava/util/List<Lcom/google/android/exoplayer2/mediacodec/MediaCodecInfo;>;"
    if-eqz v0, :cond_0

    .line 171
    .end local v0    # "cachedDecoderInfos":Ljava/util/List;, "Ljava/util/List<Lcom/google/android/exoplayer2/mediacodec/MediaCodecInfo;>;"
    :goto_0
    monitor-exit v8
    ...
    .line 148
    .restart local v0    # "cachedDecoderInfos":Ljava/util/List;, "Ljava/util/List<Lcom/google/android/exoplayer2/mediacodec/MediaCodecInfo;>;"
    :cond_0
    :try_start_1
    ...
    .line 150
    .local v5, "mediaCodecList":Lcom/google/android/exoplayer2/mediacodec/MediaCodecUtil$MediaCodecListCompat;
    :goto_1
    invoke-static {v4, v5, p0}, Lcom/google/android/exoplayer2/mediacodec/MediaCodecUtil;->getDecoderInfosInternal(Lcom/google/android/exoplayer2/mediacodec/MediaCodecUtil$CodecKey;Lcom/google/android/exoplayer2/mediacodec/MediaCodecUtil$MediaCodecListCompat;Ljava/lang/String;)Ljava/util/ArrayList;

    move-result-object v1

    .line 151
    .local v1, "decoderInfos":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/google/android/exoplayer2/mediacodec/MediaCodecInfo;>;"
    if-eqz p1, :cond_1
    ...
    .end local v5    # "mediaCodecList":Lcom/google/android/exoplayer2/mediacodec/MediaCodecUtil$MediaCodecListCompat;
    const/4 v7, 0x0

    invoke-direct {v5, v7}, Lcom/google/android/exoplayer2/mediacodec/MediaCodecUtil$MediaCodecListCompatV16;-><init>(Lcom/google/android/exoplayer2/mediacodec/MediaCodecUtil$1;)V

    .line 155
    .restart local v5    # "mediaCodecList":Lcom/google/android/exoplayer2/mediacodec/MediaCodecUtil$MediaCodecListCompat;
    invoke-static {v4, v5, p0}, Lcom/google/android/exoplayer2/mediacodec/MediaCodecUtil;->getDecoderInfosInternal(Lcom/google/android/exoplayer2/mediacodec/MediaCodecUtil$CodecKey;Lcom/google/android/exoplayer2/mediacodec/MediaCodecUtil$MediaCodecListCompat;Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    iget-boolean v9, v4, Lcom/google/android/exoplayer2/mediacodec/MediaCodecUtil$CodecKey;->secure:Z

    invoke-direct {v3, v7, v9}, Lcom/google/android/exoplayer2/mediacodec/MediaCodecUtil$CodecKey;-><init>(Ljava/lang/String;Z)V

    .line 165
    .local v3, "eac3Key":Lcom/google/android/exoplayer2/mediacodec/MediaCodecUtil$CodecKey;
    invoke-static {v3, v5, p0}, Lcom/google/android/exoplayer2/mediacodec/MediaCodecUtil;->getDecoderInfosInternal(Lcom/google/android/exoplayer2/mediacodec/MediaCodecUtil$CodecKey;Lcom/google/android/exoplayer2/mediacodec/MediaCodecUtil$MediaCodecListCompat;Ljava/lang/String;)Ljava/util/ArrayList;

    move-result-object v2

    .line 166
    .local v2, "eac3DecoderInfos":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/google/android/exoplayer2/mediacodec/MediaCodecInfo;>;"
    invoke-virtual {v1, v2}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    .line 168
    .end local v2    # "eac3DecoderInfos":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/google/android/exoplayer2/mediacodec/MediaCodecInfo;>;"
    .end local v3    # "eac3Key":Lcom/google/android/exoplayer2/mediacodec/MediaCodecUtil$CodecKey;
    :cond_2
    invoke-static {v1}, Lcom/google/android/exoplayer2/mediacodec/MediaCodecUtil;->applyWorkarounds(Ljava/util/List;)V
    ...
    .line 170
    .local v6, "unmodifiableDecoderInfos":Ljava/util/List;, "Ljava/util/List<Lcom/google/android/exoplayer2/mediacodec/MediaCodecInfo;>;"
    sget-object v7, Lcom/google/android/exoplayer2/mediacodec/MediaCodecUtil;->decoderInfosCache:Ljava/util/HashMap;
    ...
    .line 148
    .end local v1    # "decoderInfos":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/google/android/exoplayer2/mediacodec/MediaCodecInfo;>;"
    .end local v5    # "mediaCodecList":Lcom/google/android/exoplayer2/mediacodec/MediaCodecUtil$MediaCodecListCompat;
    .end local v6    # "unmodifiableDecoderInfos":Ljava/util/List;, "Ljava/util/List<Lcom/google/android/exoplayer2/mediacodec/MediaCodecInfo;>;"
    :cond_3
    new-instance v5, Lcom/google/android/exoplayer2/mediacodec/MediaCodecUtil$MediaCodecListCompatV16;
    ...
    .line 143
    .end local v0    # "cachedDecoderInfos":Ljava/util/List;, "Ljava/util/List<Lcom/google/android/exoplayer2/mediacodec/MediaCodecInfo;>;"
    .end local v4    # "key":Lcom/google/android/exoplayer2/mediacodec/MediaCodecUtil$CodecKey;
    :catchall_0
    move-exception v7
...
.method private static getDecoderInfosInternal(Lcom/google/android/exoplayer2/mediacodec/MediaCodecUtil$CodecKey;Lcom/google/android/exoplayer2/mediacodec/MediaCodecUtil$MediaCodecListCompat;Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-static {v3, v4, v12, v0}, Lcom/google/android/exoplayer2/mediacodec/MediaCodecUtil;->isCodecUsableDecoder(Landroid/media/MediaCodecInfo;Ljava/lang/String;ZLjava/lang/String;)Z
    ...
    invoke-static {v4, v9, v2, v7, v0}, Lcom/google/android/exoplayer2/mediacodec/MediaCodecInfo;->newInstance(Ljava/lang/String;Ljava/lang/String;Landroid/media/MediaCodecInfo$CodecCapabilities;ZZ)Lcom/google/android/exoplayer2/mediacodec/MediaCodecInfo;
    ...
    invoke-static {v0, v9, v2, v7, v1}, Lcom/google/android/exoplayer2/mediacodec/MediaCodecInfo;->newInstance(Ljava/lang/String;Ljava/lang/String;Landroid/media/MediaCodecInfo$CodecCapabilities;ZZ)Lcom/google/android/exoplayer2/mediacodec/MediaCodecInfo;
    ...
    .restart local v3    # "codecInfo":Landroid/media/MediaCodecInfo;
    .restart local v4    # "codecName":Ljava/lang/String;
    .restart local v5    # "decoderInfos":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/google/android/exoplayer2/mediacodec/MediaCodecInfo;>;"
...
.method private static isCodecUsableDecoder(Landroid/media/MediaCodecInfo;Ljava/lang/String;ZLjava/lang/String;)Z
    ...
    const-string v1, "OMX.Exynos.AAC.Decoder"
    ...
    const-string v1, "OMX.MTK.AUDIO.DECODER.DSPAC3"
