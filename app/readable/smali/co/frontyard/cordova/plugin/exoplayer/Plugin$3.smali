.class Lco/frontyard/cordova/plugin/exoplayer/Plugin$3;
...
.method constructor <init>(Lco/frontyard/cordova/plugin/exoplayer/Plugin;Lco/frontyard/cordova/plugin/exoplayer/Plugin;Lorg/apache/cordova/CallbackContext;)V
    ...
    .prologue
    .line 70
    iput-object p1, p0, Lco/frontyard/cordova/plugin/exoplayer/Plugin$3;->this$0:Lco/frontyard/cordova/plugin/exoplayer/Plugin;

    iput-object p2, p0, Lco/frontyard/cordova/plugin/exoplayer/Plugin$3;->val$self:Lco/frontyard/cordova/plugin/exoplayer/Plugin;

    iput-object p3, p0, Lco/frontyard/cordova/plugin/exoplayer/Plugin$3;->val$callbackContext:Lorg/apache/cordova/CallbackContext;
...
.method public run()V
    ...
    .prologue
    .line 72
    iget-object v0, p0, Lco/frontyard/cordova/plugin/exoplayer/Plugin$3;->val$self:Lco/frontyard/cordova/plugin/exoplayer/Plugin;
    ...
    invoke-virtual {v0}, Lco/frontyard/cordova/plugin/exoplayer/Player;->playPause()V

    .line 73
    new-instance v0, Lco/frontyard/cordova/plugin/exoplayer/CallbackResponse;

    iget-object v1, p0, Lco/frontyard/cordova/plugin/exoplayer/Plugin$3;->val$callbackContext:Lorg/apache/cordova/CallbackContext;
